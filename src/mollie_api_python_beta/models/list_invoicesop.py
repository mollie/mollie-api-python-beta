...
from mollie_api_python_beta.utils import FieldMetadata, QueryParamMetadata
import pydantic
...
class ListInvoicesRequest(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = ["reference", "year", "from", "limit"]
        nullable_fields = ["reference", "year", "limit"]
        null_default_fields = []
