...
from mollie_api_python_beta.utils import FieldMetadata, PathParamMetadata
import pydantic
...
class GetInvoiceResponseBodyTypedDict(TypedDict):
    ...
    r"""Indicates the response contains an invoice object. Will always contain the string `invoice` for this endpoint."""
    id: NotRequired[str]
