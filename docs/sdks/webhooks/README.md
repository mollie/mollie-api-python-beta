...
with ClientSDK(
    ...
    res = client_sdk.webhooks.list(from_="hook_B2EyhTH5N4KWUnoYPcgiH", limit=50, sort=mollie.ListSort.DESC, event_types=mollie.WebhookEventTypes.PAYMENT_LINK_PAID, testmode=False)
