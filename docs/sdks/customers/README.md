...
with ClientSDK(
    ...
    res = client_sdk.customers.list(from_="cst_5B8cwPMGnU", limit=50, sort=mollie.ListSort.DESC, testmode=False)
...
with ClientSDK(
    ...
    res = client_sdk.customers.get(customer_id="cst_5B8cwPMGnU", include="events", testmode=False)
...
with ClientSDK(
    ...
    res = client_sdk.customers.update(customer_id="cst_5B8cwPMGnU", entity_customer={
        "id": "cst_5B8cwPMGnU",
        "name": "John Doe",
        "email": "example@email.com",
        "locale": mollie.LocaleResponse.EN_US,
...
with ClientSDK(
    ...
    res = client_sdk.customers.create_payment(customer_id="cst_5B8cwPMGnU", payment_request=mollie.PaymentRequest(
        id="tr_5B8cwPMGnU",
...
with ClientSDK(
    ...
    res = client_sdk.customers.list_payments(customer_id="cst_5B8cwPMGnU", from_="tr_5B8cwPMGnU", limit=50, sort=mollie.ListSort.DESC, profile_id="pfl_5B8cwPMGnU", testmode=False)
