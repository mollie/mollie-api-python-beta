...
with ClientSDK(
    ...
    res = client_sdk.customers.list(from_="cst_5B8cwPMGnU", limit=50, sort=mollie.Sorting.DESC, testmode=False, idempotency_key="123e4567-e89b-12d3-a456-426")
...
with ClientSDK(
    ...
    res = client_sdk.customers.list_payments(customer_id="cst_5B8cwPMGnU", from_="tr_5B8cwPMGnU", limit=50, sort=mollie.Sorting.DESC, profile_id="pfl_5B8cwPMGnU", testmode=False, idempotency_key="123e4567-e89b-12d3-a456-426")
