...
with ClientSDK(
    ...
    res = client_sdk.balance_transfers.list(limit=50, sort=mollie.ListSort.DESC, testmode=False, idempotency_key="123e4567-e89b-12d3-a456-426")
...
<!-- UsageSnippet language="python" operationID="get-connect-balance-transfer" method="get" path="/connect/balance-transfers/{id}" -->
```python
import mollie
from mollie import ClientSDK
import os
...
with ClientSDK(
    ...
    res = client_sdk.balance_transfers.get(id="<id>", testmode=False, idempotency_key="123e4567-e89b-12d3-a456-426")
