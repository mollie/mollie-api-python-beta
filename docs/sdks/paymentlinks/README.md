...
with ClientSDK(
    ...
    res = client_sdk.payment_links.list_payments(payment_link_id="pl_d9fQur83kFdhH8hIhaZfq", from_="tr_5B8cwPMGnU", limit=50, sort=mollie.Sorting.DESC, testmode=False, idempotency_key="123e4567-e89b-12d3-a456-426")
